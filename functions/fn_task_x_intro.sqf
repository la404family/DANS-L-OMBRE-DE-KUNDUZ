/*
    ...
    Characteristics :
        ...
        - Points de référence : batiment_officer, waypoint_invisible_XXX (000-340)
...
if (hasInterface) then {
    [] spawn {
        ...
        // ==============================================================================================
        sleep 0.1;  // Court délai pour stabilisation
        ...
        // MODIFICATION : Changez 341 par le nombre de waypoints invisibles disponibles
        private _randomPosIndex1 = floor (random 341);
        private _posName1 = "";
        
        // Logique de formatage pour correspondre aux noms "waypoint_invisible_000" à "waypoint_invisible_340"
        ...
        // ==============================================================================================
        playMusic "intro_00";   // Démarre la musique d'intro (définie dans description.ext)
        ...
        // Y = 0.8 : 0.8 mètre vers l'arrière (fond du cargo)
        // Z = -0.7 : légèrement sous le niveau des sièges pour une vue immersive
       ...
       // ##############################################################################################
        ...
        while { !isTouchingGround _camHeli && (getPos _camHeli select 2) > 1 } do {
            ...
            private _descent = _progress * 5; // Descente plus douce
            ...
            // Zoom progressif vers le QG (réduction du FOV) pour compenser l'arrêt de la descente
...
if (isServer) then {
    [] spawn {
        ...
        // NOTE IMPORTANTE : Pour changer l'hélicoptère, modifiez la variable 'MISSION_var_helicopters' dans le fichier init.sqf
        // Ne modifiez pas le code ici à moins de changer la logique de sélection.
        private _heliData = [];
        { 
